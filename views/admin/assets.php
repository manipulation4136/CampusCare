                            ...
                            <tr>
                                <td>
                                    <div class="table-actions">
                                        <a href="<?= BASE_URL ?>views/admin/view_asset.php?id=<?= $a['id'] ?>" class="btn icon-btn" style="color: #3498db; border: 1px solid rgba(52, 152, 219, 0.3);" title="View Asset Details">
                                ...
                                <td>
                                    <div class="table-actions">
                                        <a href="<?= BASE_URL ?>views/admin/forms/edit_asset.php?id=<?= $a['id'] ?>" class="btn icon-btn" style="color: #f39c12;" title="Edit Asset">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form method="POST" style="margin: 0;" onsubmit="return confirm('Are you sure you want to delete this asset? This action cannot be undone.');">
                                            <?= get_csrf_input() ?>
